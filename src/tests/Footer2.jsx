...
import { Bar, CopyrightContainer, FooterContainer, Link, Link1, LinkContainer, MiddleContainer, SideContainer, VerticalBar } from './Footer2Styled'
  ...
  return (
    <FooterContainer>
      ...
      <MiddleContainer>
        ...
        <VerticalBar />
        <CopyrightContainer>
          <Logo size="12px"/>&nbsp;&nbsp;<FaRegCopyright color="white"/>&nbsp;Tous droits réservés
        </CopyrightContainer>
      </MiddleContainer>
