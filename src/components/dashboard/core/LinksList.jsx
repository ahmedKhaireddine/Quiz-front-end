...
import { Item, ListItems, Title } from "../../../styles/dashboard/LinksListStyled"
...
const LinksList = (props) => {
  ...
  return (
    <ListItems>
      ...
      <Item selected={view === "Questionnaires"} onClick={() => setView("Questionnaires")}>
      ...
      {user && user.role === "admin" && (
        <>
          ...
          <Item selected={view === "Accounts"} onClick={() => setView("Accounts")}>
      ...
      <Item selected={view === "QuestionEdit"} onClick={() => setView("QuestionEdit")}>
        <AiFillMessage color="rgba(31,147,155,.8)" fontSize="1.4em"/>
